...
const tourSchema = new mongoose.Schema(
  {
    ...
    difficulty: {
      type: String,
      required: [true, 'Difficulty should be set'],
      enum: {
    ...
    ratingsQuantity: {
      ...
      // max: [5, 'Rating must equal or below 5'],
    },
    price: {
      type: Number,
    ...
    createdAt: {
      type: Date,
      default: Date.now(),
      select: false, //making it inaccessible to the client side;
    },
    startDates: [Date],
    secretTour: {
      type: Boolean,

...
var showAlert = function showAlert(type, msg) {
  hideAlert(); // console.log('hit here', type);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            // console.log(res);
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " update successful"));
            }
...
var stripe = Stripe('pk_test_51KvKiOFoV9coXQx6nPtHRhqogOy6xs1xgF5H5I6uW20lZPooGBRuT5xxquCgGDveLGWeLzgI2LthD4Cudw9ZERn700J8UyfwRi');
...
if (mapBox) {
  ...
  var locations = JSON.parse((_document$getElementB = document.getElementById('map')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.dataset.locations);
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              form = new FormData(); // multipart form data
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn--save-password').textContext = 'Updating...'; // console.log('start');
